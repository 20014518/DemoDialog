package sg.edu.rp.c346.id20014518.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvdmeo2 = findViewById(R.id.textViewDemo2);
        ...
        btnexercise4 = findViewById(R.id.buttonDemo4);
        tvexercise4 = findViewById(R.id.textViewDemo4);

        btnexercise5 = findViewById(R.id.buttonDemo5);
        tvexercise5 = findViewById(R.id.textViewDemo5);
